...
# the pure beat-v6 base checkpoint used before the ClinVar regime-A fine-tune.
#
...
#
# Optional overrides:
#   EXPERIMENT=ntv3-beat-v6-official-human-functional-seed0 \
#   BUCKET=ai4bio-lumina-experiments-v2 \
#   INSTANCE_TYPE=ml.p5en.48xlarge \
#   TRAINING_IMAGE_URI=<custom-image> \
#   bash scripts/dispatch_ntv3_beat_v6_full.sh
set -euo pipefail
...
EXPERIMENT="${EXPERIMENT:-ntv3-beat-v6-official-human-functional-seed0}"
CHECKPOINT_S3_PREFIX="${CHECKPOINT_S3_PREFIX:-s3://ai4bio-lumina-experiments-v2/lumina-ssm/data/checkpoints/beat-v6-12m-15ep-32k/}"
