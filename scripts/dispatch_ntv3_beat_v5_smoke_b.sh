#!/usr/bin/env bash
# Dispatch the second diagnostic NTv3 smoke run: DDP enabled, workers disabled.
#
...
EXPERIMENT="${EXPERIMENT:-ntv3-beat-v5-smoke-b-seed42}"
...
NUM_STEPS_TRAINING="${NUM_STEPS_TRAINING:-50}"
VALIDATE_EVERY_N_STEPS="${VALIDATE_EVERY_N_STEPS:-25}"
SAVE_EVERY_N_STEPS="${SAVE_EVERY_N_STEPS:-25}"
