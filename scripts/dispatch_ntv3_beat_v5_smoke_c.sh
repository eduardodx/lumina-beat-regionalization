#!/usr/bin/env bash
# Dispatch the third diagnostic NTv3 smoke run: DDP enabled with the stable worker configuration.
#
...
EXPERIMENT="${EXPERIMENT:-ntv3-beat-v5-smoke-c-seed42}"
...
MAX_RUN_HOURS="${MAX_RUN_HOURS:-24}"
...
NUM_STEPS_TRAINING="${NUM_STEPS_TRAINING:-500}"
VALIDATE_EVERY_N_STEPS="${VALIDATE_EVERY_N_STEPS:-100}"
