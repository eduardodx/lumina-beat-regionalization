...
class BeatV4Block(BeatBlock):
    pass


class DNAFoundationBeatV4(nn.Module):
    def __init__(self, cfg: BeatV4Config) -> None:
        super().__init__()
        self.cfg = cfg
...
def build_beat_v4_model(cfg: BeatV4Config) -> DNAFoundationBeatV4:
    return DNAFoundationBeatV4(cfg)
