"""PORTADO da pesquisa de extracao, SEM alteracao de comportamento.

Origem: branch `embedding-probe-mosaic`, commit 23fb518997ee7c68d843ae55bc2e1409ddf24cde, caminho `eval/embedding_probe/windows.py`.
A equivalencia com a origem e verificada em tests/test_rich_port_fidelity.py.

POLITICA PARA N E SOFT-MASK (declarada na secao 5.2 do plano): `_fetch_validated` normaliza a janela para
maiusculo (resolve soft-mask) e DESCARTA a variante cuja janela tenha base fora de ACGT, com o motivo
`non_acgt`. Nao ha substituicao nem mascaramento: a variante sai do conjunto e entra na contagem declarada.
