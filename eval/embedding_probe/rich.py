...
Origem: branch `embedding-probe-mosaic`, commit 23fb518997ee7c68d843ae55bc2e1409ddf24cde, caminho `eval/embedding_probe/rich.py`.
A equivalencia com a origem e verificada em tests/test_embedding_probe_rich_port.py, que carrega o arquivo
daquele commit via `git show` e compara as saidas. Qualquer mudanca de comportamento aqui tem de quebrar
aquele teste antes de ser aceita.
